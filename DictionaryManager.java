...
public class DictionaryManagement {
    ...
    public void dictionaryLookup() {
        ...
        if (foundWord != null) {
            System.out.println("Found: " + foundWord.getWordTarget() + " - " + foundWord.getWordExplain());
        } else {
            System.out.println("Word not found.");
        }
        // It might be better not to close the scanner here if it's used elsewhere
    }
    ...
    public void insertFromCommandLine() {
        Scanner scanner = new Scanner(System.in);
        System.out.print("Enter the number of group of words to add: ");
